 ...
 * 与 memory_rank.js 同一个「纯核 + node 行为门」哲学（AGENTS.md §6）。
 *
 *   · 浏览器：ES Module（importmap 键 #dream_core，C1 起），dream.js 经 import 调用；
...
/* 与既有记忆去重：候选条与任一既有记忆同文 → 不再呈现给用户勾选。
   ...
   2026-08-08 B6 调研六候选批（Mem0 对账思想的前端落地，ADD/NOOP 版）：
