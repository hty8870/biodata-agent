...
/* 追踪导出中心 UI 壳（engagement Wave 2 P5，设计 §6）。
 *
 ...
 *     `[data-p5-mount-export]` 挂点（ENG-P5-MOUNT 区域内）就渲染导出区——P5 未落地时
...
async function pexRender() {
    ...
    if (section) section.hidden = false;   // 展开 projects.js 默认隐藏的导出区（无 P5 时保持隐藏）
