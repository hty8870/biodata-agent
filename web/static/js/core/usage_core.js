...
export const USAGE_KINDS = {
    ...
    //  ---- engagement F1 追踪（计数型无文本——追踪名/query/uid 不进遥测，设计 §1.3）----
    ...
    //  ---- engagement P4 追踪更新检查闭环（设计 §4/§10）----
...
export function usageSummarize(events, opts) {
    ...
    //  读的人会以为它跟上一节（未用词）有关 —— 验证 dump 出来一眼就看见了，代码里看不出来。
...
/* ============================================================================
 * 遥测上传包构造（tl1 S2）——仍保持纯核纪律：无 DOM / 无存储 /
