...
/* 追踪更新检查 · 纯逻辑核（engagement P4 = 设计 v2 §4「F3 追踪更新检查闭环」）
 *
 * ## 本文件是什么 / 不是什么
 *
 ...
 * 上游同步编排与语料代哨兵的纯推导（corpus-sync 批；全体批量按钮已撤）。
 *   设计见 engagement 落地包 §4.1/§4.2/§4.3/§4.4。
...
/* 单追踪检查回执（设计 §4.4「结果汇总如实呈现」+ 用户口径「检查了 N 个，X 个有更新，
