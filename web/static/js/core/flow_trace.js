...
/* ============================================================================
 * flow_trace.js —— 信息流（ku3）· 过程轨迹纯逻辑核（ku3-w3 用户重申定稿版）
 * ----------------------------------------------------------------------------
 ...
 *   stageFromEvent 对它返回 null——ku3-w1 的「已完成分流」行与 KIND_ROUTE/KIND_PRELIM 一并退役，
...
/* ---------- 事件 → 工具行描述（事件钩子机械触发；react 环零改动） ----------
   ...
   ——天然同 id，upsertStage 更新同一行，不再出现「pending 行 + ✓ 行」并列两行（ku3-w3 缺陷 0）。
