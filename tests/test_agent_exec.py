# -*- coding: utf-8 -*-
"""agent_exec（langgraph 执行侧编排，2026-08-03 agent1）的确定性门。**全离线**：
...
def test_route_turn_use_agent_false_skips_the_agent(monkeypatch):
    ...
    LLM 分流器**双双不启动**（2026-08-03 agent2 起 agent 标志 = 分流器总闸，
...
# ---------------------------------------------------------------- 流式（plan_with_agent_events，agent1b）
