...
# 2026-08-16 检索工具化 Phase 1：webapp 的私有 `_format_sample_size` 已删——web 渲染路径
...
# G-08（2026-08-15 ta2）只翻 ArrayExpress 猜测档（见 test_guessed_false_from_arrayexpress_shows_unconfirmed）；
...
def test_guessed_false_from_arrayexpress_shows_unconfirmed():
    """G-08（2026-08-15 ta2）：ArrayExpress 的 has_raw_data=False 是抓取时的保守占位
