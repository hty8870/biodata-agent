 ...
 * 真实时序错误）。经 artifactsSetIdbFactory 注入；真机走全局 indexedDB，同一套代码。
 * 相对路径 import，避开中文路径入 argv。
 * ========================================================================== */

import * as A from "../../web/static/js/core/artifacts.js";

const T0 = 1753000000000;   // 固定基准：2025-07-20 前后（脚本内一切时间由此推出，确定性）
 ...
 * ========================================================================== */
{
    ...
    /* 2026-08-22 eng-close：ISO 字符串时间戳（服务端 checked_at 直传）不得落成 epoch 0；
