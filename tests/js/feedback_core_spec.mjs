...
/* ENG-B3-PUBKEY：2026-08-22 协调者收口已填生产公钥（P-256 raw 未压缩点 65 字节的
...
check("ENG-B3-PUBKEY 已填生产公钥（65B raw 未压缩点、0x04 前缀）",
...
check("ENG-B3-PUBKEY 可被 WebCrypto 以 raw/ECDH/P-256 导入", prodPubImportable);
