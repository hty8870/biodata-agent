 ...
 * 文案是否如实」「结果摘要是否绝不写『更新 Y』」「sync_busy 是否按设计 §7 文案上屏」
...
function copySuite() {
    ...
    check("sync_busy 上屏文案（设计 §7）",
        S.SYNC_BUSY_COPY === "另一个同步任务进行中，请稍候", S.SYNC_BUSY_COPY);
    check("P4 联动已退役（2026-08-26 corpus-sync 批：常量不再导出）",
...
/* ============================================================================
 * 2. 空闲态「上次同步」文案（设计 §7：实例级事实，从未同步如实写）
 * ========================================================================== */
...
/* ============================================================================
 * 3. 结果摘要（设计 §7：新增 X / 已存在 Z / 失败 W，绝不写「更新 Y」）
 * ========================================================================== */
...
/* ============================================================================
 * 6. 失败分类（sync_busy 按设计 §7 文案；其余如实透出）
 * ========================================================================== */
function classifySuite() {
    ...
    check("400 + detail 含「同步」→ sync_busy + 设计 §7 文案",
...
/* ============================================================================
 * 7. P4 联动已退役（2026-08-26 corpus-sync 批：全体批量按钮删除，本套件无 P4 用例）
 * ========================================================================== */
