...
/* ---------- 5b. 「一条都没点」不许串到别的小节里去 ---------- */
{
    // 真机 dump 抓到的排版缺陷：没有任何 open 事件时，「有结果但一条都没点」
...
/* ---------- 14. 遥测上传包构造（buildTelemetryPackage，2026-08-20 tl1）---------- */
{
...
/* ---------- 15. 遥测 ID 层（2026-08-22 ov1-tel1，schema v2）---------- */
{
...
/* ---------- 16. 值级遮蔽（手机号/证件号/邮箱，2026-08-22 ov1-tel1）---------- */
{
...
/* ---------- 17. mcp_records 中继附加（2026-08-22 ov1-tel1）---------- */
{
...
/* ---------- 18. schema v3 与新 kind 登记（2026-08-22 ov1-fix1a）---------- */
{
...
/* ---------- 19. 曝光可见状态机（usageSeenTick/Pause，ov1-fix1a）---------- */
{
...
/* ---------- 20. ID 形态：randomUUID 优先（ov1-fix1a）---------- */
{
