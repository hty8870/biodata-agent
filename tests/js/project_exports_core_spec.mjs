 ...
 * 字段对齐」这些用户可见核心逻辑——错一处就是设计 §6 台账语义的红线事故。
 *
...
/* ============================================================================
 * 1. 常量（设计 §6 的四种导出动作，按钮文案逐字；端点与后端同源）
 * ========================================================================== */
function constantsSuite() {
    check("四种导出动作文案（设计 §6 逐字）",
...
/* ============================================================================
 * 3. 台账 diff（零 LLM，设计 §6「新增 N 候选 · 状态变化 M」）
 * ========================================================================== */
function changesSuite() {
    ...
    check("状态文案：新增 N 候选 · 状态变化 M（设计 §6 原文）",
