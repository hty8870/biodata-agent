...
def test_encode_is_unknown_genre_and_not_translatable() -> None:
    """ENCODE（第六来源，2026-08-01 正式提升）：本模块尚未读过 encode ingest 契约，
...
def test_missing_source_is_unknown_not_scaffold() -> None:
    """G-06（2026-08-15）：缺 source 的记录**不再是**默认 10x（scaffold）。
...
def test_zenodo_and_refinebio_are_prose() -> None:
    """G-06（2026-08-15）：Zenodo / refine.bio 的 description 是来源真实叙述 = 真散文。
