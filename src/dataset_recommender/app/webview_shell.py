...
背景（桌面壳批 zcode/desktop-shell，实现 只读验证结论已并入）：
...
if os.name == "nt":
    ...
    # W5 跨平台核查修复：wintypes 是 Windows 专有——此前顶层无条件导入，
...
# 小屏研判（安装版完善波次A）：1240×760 在 1366×768+任务栏的小屏上仍会超高。
