...
（收口交接 `协同/交接/kimi-sec-s3-webapp-遗留.md` 第 4 项，ov1-mcp1 批）。

值取 **100**：以 Web 既有上限（PERF-M01，2026-08-06 起）为准，MCP 从硬上限 200 收窄到 100——
...
`tests/test_webapp_sec_s3.py`（422 钉）、`tests/test_mcp_server.py`（bad_param 钉）与本文件注释原子更新。
"""
